...
from PyQt6.QtWidgets import QToolButton, QWidget, QTabWidget, QTabBar
...
class TabWidget(QTabWidget):
    ...
    def create_new_tab(self, url: str | None = None) -> QWebEngineView:
        ...
        # Connect signals
        web_view.titleChanged.connect(lambda title: self._update_tab_title(web_view, title))
        web_view.urlChanged.connect(self._on_url_changed)
        web_view.loadStarted.connect(lambda: self._update_tab_title(web_view, "Loading..."))
